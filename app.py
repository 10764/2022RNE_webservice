...
if gubun == "강력범죄간 상관관계" :
    ...
    with t1 : 
        ...
        data = pd.read_csv('0~9세비율.csv', encoding = 'UTF-8')
        st.dataframe(data, use_container_width = True)
    ...
    with t3 :
        ...
        data = pd.read_csv('기초생활수급자수비율.csv', encoding = 'UTF-8')
        st.dataframe(data, use_container_width = True)
